...
import cn.appssec.downloadmanager.Downloads;
import cn.appssec.downloadmanager.IoUtils;
import cn.appssec.downloadmanager.MathUtils;

import static android.text.format.DateUtils.SECOND_IN_MILLIS;
import static cn.appssec.downloadmanager.DownloadManager.COLUMN_STATUS;
import static cn.appssec.downloadmanager.Downloads.Impl.COLUMN_CONTROL;
import static cn.appssec.downloadmanager.Downloads.Impl.COLUMN_DELETED;
import static cn.appssec.downloadmanager.Downloads.Impl.CONTROL_PAUSED;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_BAD_REQUEST;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_CANCELED;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_CANNOT_RESUME;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_FILE_ERROR;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_HTTP_DATA_ERROR;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_PAUSED_BY_APP;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_QUEUED_FOR_WIFI;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_RUNNING;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_SUCCESS;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_TOO_MANY_REDIRECTS;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_UNHANDLED_HTTP_CODE;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_UNKNOWN_ERROR;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_WAITING_FOR_NETWORK;
import static cn.appssec.downloadmanager.Downloads.Impl.STATUS_WAITING_TO_RETRY;
...
//                        + Uri.parse(url.toString()).toSafeString());
    ...
    private void transferData(HttpURLConnection conn) throws StopRequestException {
        ...
        try {
            ...
            try {
                Log.e(TAG, "begin transfer");
                Log.e(TAG, "descriptor uri : " + mInfo.getAllDownloadsUri());
                outPfd = mContext.getContentResolver()
                        .openFileDescriptor(mInfo.getAllDownloadsUri(), "rw");
                Log.e(TAG, " get out Pfd");
                outFd = outPfd.getFileDescriptor();
                Log.e(TAG, "get out fd");
...
//                    StorageUtils.ensureAvailableSpace(mContext, outFd, newBytes);
                ...
                Log.d(TAG, "HttpURLConnection transfer data errno exception : " + e.getMessage());
                throw new StopRequestException(STATUS_FILE_ERROR, e);
            } catch (FileNotFoundException e) {
                Log.d(TAG, "HttpURLConnection transfer data  IOException : " + e.getMessage());
                throw new StopRequestException(STATUS_FILE_ERROR, e);
            }
    ...
    private void transferData(InputStream in, OutputStream out, FileDescriptor outFd)
        ...
        while (true) {
            ...
            try {
                ...
                Log.d(TAG, "FileDescriptor transfer data  ErrnoException : " + e.getMessage());
                throw new StopRequestException(STATUS_FILE_ERROR, e);
            } catch (IOException e) {
                Log.d(TAG, "FileDescriptor transfer data  IOException : " + e.getMessage());
                throw new StopRequestException(STATUS_FILE_ERROR, e);
            }
        }
    ...
    private void parseOkHeaders(HttpURLConnection conn) throws StopRequestException {
        if (mInfoDelta.mFileName == null) {
            ...
            try {
                ...
                Log.d(TAG, "parseOkHeaders : " + e.getMessage());
                throw new StopRequestException(
