...
import static cn.appssec.downloadmanager.DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED;
import static cn.appssec.downloadmanager.Downloads.Impl.VISIBILITY_VISIBLE;
...
public class DownloadInfo {
    ...
    public void sendIntentIfRequested() {
        Log.e(TAG, "sendIntentIfRequested1");
        if (mPackage == null) {
            Log.e(TAG, " mpkg is null");
            mPackage = "io.virtualapp";
//            return;
        }
        Log.e(TAG, "pkg : " + mPackage);
        Log.e(TAG, "sendIntentIfRequested2");
        Intent intent;
        if (mIsPublicApi) {
            Log.e(TAG, "sendIntentIfRequested3");
...
//            intent.setPackage(mPackage);
            ...
            Log.e(TAG, "sendIntentIfRequested4");
            if (mClass == null) {
                return;
            }
            Log.e(TAG, "sendIntentIfRequested5");
        ...
        Log.e(TAG, "sendIntentIfRequested6");
