...
import cn.appssec.downloadmanager.DownloadManager.Request;
import cn.appssec.downloadmanager.DownloadManager;
import cn.appssec.downloadmanager.Downloads;
//import libcore.io.IoUtils;

import static cn.appssec.downloadmanager.Downloads.Impl.COLUMN_DESTINATION;
import static cn.appssec.downloadmanager.Downloads.Impl.COLUMN_MEDIA_SCANNED;
import static cn.appssec.downloadmanager.Downloads.Impl.COLUMN_MIME_TYPE;
import static cn.appssec.downloadmanager.Downloads.Impl.DESTINATION_NON_DOWNLOADMANAGER_DOWNLOAD;
import static cn.appssec.downloadmanager.Downloads.Impl._DATA;
...
public final class DownloadProvider extends ContentProvider {
    ...
    static {
        sURIMatcher.addURI("cn.appssec.downloadmanager.downloads", "my_downloads", MY_DOWNLOADS);
        sURIMatcher.addURI("cn.appssec.downloadmanager.downloads", "my_downloads/#", MY_DOWNLOADS_ID);
        sURIMatcher.addURI("cn.appssec.downloadmanager.downloads", "all_downloads", ALL_DOWNLOADS);
        sURIMatcher.addURI("cn.appssec.downloadmanager.downloads", "all_downloads/#", ALL_DOWNLOADS_ID);
        sURIMatcher.addURI("cn.appssec.downloadmanager.downloads",
        ...
        sURIMatcher.addURI("cn.appssec.downloadmanager.downloads", "download", MY_DOWNLOADS);
        sURIMatcher.addURI("cn.appssec.downloadmanager.downloads", "download/#", MY_DOWNLOADS_ID);
        sURIMatcher.addURI("cn.appssec.downloadmanager.downloads",
...
//    @VisibleForTesting
    ...
    private final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void makeCacheDownloadsInvisible(SQLiteDatabase db) {
            ...
            String cacheSelection = COLUMN_DESTINATION
        ...
        switch (match) {
            ...
            case PUBLIC_DOWNLOAD_ID: {
                ...
                final String mimeType = DatabaseUtils.stringForQuery(db,
                        "SELECT " + COLUMN_MIME_TYPE + " FROM " + DB_TABLE +
    ...
    public Uri insert(final Uri uri, final ContentValues values) {
        ...
        copyString(COLUMN_MIME_TYPE, values, filteredValues);
        ...
        Integer dest = values.getAsInteger(COLUMN_DESTINATION);
        if (dest != null) {
...
//                        "need ACCESS_CACHE_FILESYSTEM permission to use system cache");
            ...
            filteredValues.put(COLUMN_DESTINATION, dest);
        }
         ...
         */
        if (values.getAsInteger(COLUMN_DESTINATION) ==
            ...
            copyInteger(COLUMN_MEDIA_SCANNED, values, filteredValues);
...
//            }
    ...
    private void checkInsertPermissions(ContentValues values) {
        ...
        enforceAllowedValues(values, COLUMN_DESTINATION,
        ...
        values.remove(COLUMN_MIME_TYPE);
        ...
        values.remove(COLUMN_MEDIA_SCANNED);
...
//            IoUtils.closeQuietly(probeCursor);
        ...
        final Cursor cursor = queryCleared(uri, new String[] {
                _DATA, Downloads.Impl.COLUMN_STATUS,
                COLUMN_DESTINATION, COLUMN_MEDIA_SCANNED }, null,
                null, null);
        final String path;
